...
| E5 | Betriebsumgebung Hub (F1) | **Lokaler Betrieb auf Team-Node-1 (User-PC) für ganz P0** — Cloud-VM entfällt (D017); Backend/Ticks lokal, Cowork-Sessions für Engineering; Infra-as-Code (`platform/infra/`) bleibt bereit; Wiedervorlage VM zum P0-Abschluss/P1-Intake | Entschieden 2026-08-05 (G0, Cloud-VM), angepasst 2026-08-06 (D014: verschoben), revidiert 2026-08-06 (D017: lokal — kostenneutral, Inbox-Einschränkung bewusst akzeptiert). |
